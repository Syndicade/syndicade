...
var PLANS = [
  {
    ...
    pagesDetail: 'A public landing page with drag-and-drop sections — hero, about, events, programs, gallery, and more. Publish once, it shows up for members and on the discovery board.',
    badge: null,
    isHighlight: false,
    features: [
  ...
  },
  {
    ...
    pagesDetail: 'A home page plus up to 6 sub-pages. Build out your full org presence — About, Programs, Team, Gallery, Donate, Contact — all with drag-and-drop components. Publish once, it shows up for members and on the discovery board.',
    badge: 'Most Popular',
    isHighlight: true,
    features: [
  ...
  },
  {
    ...
    pagesDetail: 'Unlimited pages for campaigns, programs, events, and more. No ceiling — build as your org grows. Publish once, it shows up for members and on the discovery board.',
    badge: null,
    isHighlight: false,
    features: [
  ...
  return (
    <div className="bg-[#0E1523] min-h-screen flex flex-col">
      ...
      <main id="main-content" className="flex-1">
        ...
        {/* Pricing cards */}
        <section className="px-6 pb-16 max-w-6xl mx-auto" aria-label="Pricing plans">
...
<div className="text-center mt-6 space-y-2">
  <p className="text-sm text-[#64748B]">
    All features are visible on all plans. Unavailable features are clearly marked with an upgrade prompt — you always know what's ahead.
  </p>
  ...
  <p className="text-xs text-[#64748B]">
    Have a promo code? Apply it at checkout for an extended 30-day free trial.
  </p>
</div>
        </section>
    ...
    <tbody>
      {COMPARE.map(function(row, i) {
        return (
          <tr
            key={i}
            className={'border-b border-[#2A3550] last:border-0 ' + (row.isSelf ? 'bg-[#1A2035]' : '')}
          >
            <td className={'py-4 px-4 ' + (row.isSelf ? '' : '')}>
              {row.isSelf
