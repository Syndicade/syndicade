...
import { Search, SlidersHorizontal, X, ChevronLeft, ChevronRight, ChevronDown, Building2, AlertCircle, Tag } from 'lucide-react';
        ...
        <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '24px 20px' }}>
          <div style={{ display: 'flex', gap: '24px', alignItems: 'flex-start' }}>
            ...
            <div className="hidden lg:block" style={{ width: '240px', flexShrink: 0 }}>
              <div style={{ background: sidebarBg, border: '1px solid ' + sidebarBorder, borderRadius: '12px', padding: '16px', position: 'sticky', top: '68px', transition: 'background 0.2s' }}>
            ...
            <main style={{ flex: 1, minWidth: 0 }} aria-label="Organization results">
              ...
              <div style={{ marginBottom: '20px' }}>
                <h1 style={{ fontSize: '22px', fontWeight: 800, color: headingTxt, marginBottom: '4px' }}>{t(lang, 'pageTitle') || 'Discover Local Organizations'}</h1>
                <p style={{ fontSize: '13px', color: subTxt }}>{t(lang, 'pageSubtitle') || 'Explore nonprofits and community groups in your area.'}</p>
              </div>
              ...
              {/* Skeletons */}
              {loading && (
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '20px' }} aria-label="Loading">
              ...
              {!loading && !error && orgs.length === 0 && (
                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', padding: '80px 0', textAlign: 'center' }}>
                  ...
                  <h2 style={{ fontSize: '17px', fontWeight: 700, color: headingTxt, marginBottom: '8px' }}>{t(lang, 'noResults') || 'No organizations found'}</h2>
                  <p style={{ fontSize: '13px', color: subTxt, marginBottom: '24px', maxWidth: '360px' }}>{t(lang, 'noResultsDesc') || 'Try adjusting your filters or search terms.'}</p>
