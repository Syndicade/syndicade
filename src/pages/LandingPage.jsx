  ...
  return (
    <div style={{
      ...
      <div style={{ marginBottom: '7px' }}>
        <span style={{ display: 'inline-flex', alignItems: 'center', gap: '4px', padding: '2px 8px', borderRadius: '3px', fontSize: '9px', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.5px', background: badgeBg, color: badgeText }}>
          {category}
        </span>
      </div>
      <div style={{ fontSize: large ? '15px' : '13px', fontWeight: 700, color: '#111827', lineHeight: 1.35, marginBottom: body ? '8px' : '0' }}>
        {title}
      </div>
      {body && (
        <div style={{ fontSize: '14px', fontWeight: 400, color: '#374151', lineHeight: 1.5, marginBottom: '10px', fontFamily: "'Patrick Hand', sans-serif" }}>
          {body}
        </div>
      )}
      {(org || date || btnLabel) && (
        <div style={{ borderTop: '1px solid rgba(0,0,0,0.08)', paddingTop: '8px', marginTop: '8px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '8px' }}>
          ...
          {btnLabel && (
            <button style={{ padding: '4px 12px', borderRadius: '4px', fontSize: '10px', fontWeight: 700, border: 'none', cursor: 'pointer', background: btnBg || badgeBg, color: btnTextColor || badgeText, flexShrink: 0 }}>
              {btnLabel}
            </button>
          )}
        </div>
      ...
      <header role="banner" style={{ position: 'fixed', top: 0, left: 0, right: 0, zIndex: 50, background: navBg, borderBottom: '1px solid ' + (scrolled ? borderColor : 'transparent'), backdropFilter: scrolled ? 'blur(12px)' : 'none', transition: 'all 0.25s' }}>
        <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', height: '64px' }}>
          ...
          <nav className="hidden md:flex" style={{ alignItems: 'center', gap: '4px' }} aria-label="Main navigation">
            ...
            <Link to="/discover" className="focus:outline-none focus:ring-2 focus:ring-amber-400 rounded-lg" style={{ fontSize: '14px', fontWeight: 500, color: textSecondary, padding: '6px 12px', textDecoration: 'none', transition: 'color 0.15s' }} onMouseOver={function(e) { e.currentTarget.style.color = textPrimary; }} onMouseOut={function(e) { e.currentTarget.style.color = textSecondary; }}>
              Discover Events
            </Link>
            <Link to="/explore" className="focus:outline-none focus:ring-2 focus:ring-amber-400 rounded-lg" style={{ fontSize: '14px', fontWeight: 500, color: textSecondary, padding: '6px 12px', textDecoration: 'none', transition: 'color 0.15s' }} onMouseOver={function(e) { e.currentTarget.style.color = textPrimary; }} onMouseOut={function(e) { e.currentTarget.style.color = textSecondary; }}>
              Explore Orgs
            </Link>
          </nav>
        ...
        {mobileMenuOpen && (
          <div role="navigation" aria-label="Mobile navigation" style={{ background: cardBg, borderTop: '1px solid ' + borderColor, padding: '12px 24px 20px' }}>
            ...
            <Link to="/discover" onClick={function() { setMobileMenuOpen(false); }} className="focus:outline-none focus:ring-2 focus:ring-amber-400 rounded" style={{ display: 'block', padding: '12px 0', fontSize: '14px', fontWeight: 500, color: textSecondary, borderBottom: '1px solid ' + borderColor, textDecoration: 'none' }}>Discover Events</Link>
            <Link to="/explore" onClick={function() { setMobileMenuOpen(false); }} className="focus:outline-none focus:ring-2 focus:ring-amber-400 rounded" style={{ display: 'block', padding: '12px 0', fontSize: '14px', fontWeight: 500, color: textSecondary, borderBottom: '1px solid ' + borderColor, textDecoration: 'none' }}>Explore Organizations</Link>
      ...
      <main id="main-content">
        ...
        <section aria-labelledby="hero-heading" style={{ paddingTop: '64px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))' }}>
            ...
            {/* Right — post-it board (dark bg is intentional branding) */}
          ...
          <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
            ...
            <div aria-hidden="true" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(260px, 1fr))', gap: '24px' }}>
              {[
                ...
                return <PostIt key={card.title} bg={card.bg} badgeBg={card.badgeBg} badgeText={card.badgeText} category={card.cat} title={card.title} body={card.body} org={card.org} orgColor={card.orgColor} date={card.date} />;
              })}
            </div>
        ...
        <section id="pricing" aria-labelledby="pricing-heading" style={{ padding: '80px 24px', background: pageBg, borderBottom: '1px solid ' + borderColor }}>
          <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
                ...
                {[['monthly','Monthly'],['annual','Annual']].map(function(opt) {
                  ...
                  return (
                    <button
                      ...
                      style={{ padding: '8px 20px', borderRadius: '8px', fontSize: '14px', fontWeight: 600, border: 'none', cursor: 'pointer', background: isActive ? '#FFFFFF' : 'transparent', color: isActive ? textPrimary : textMuted, boxShadow: isActive ? '0 1px 4px rgba(0,0,0,0.15)' : 'none', transition: 'all 0.15s', display: 'flex', alignItems: 'center', gap: '6px' }}
                    >
                      {opt[1]}
                      {opt[0] === 'annual' && (
            ...
            {/* Pricing cards — V3 Post-it style */}
              ...
              {PLANS.map(function(plan) {
                ...
                return (
                  <div key={plan.name} style={{ background: plan.cardBgColor, borderRadius: '12px', padding: '24px', position: 'relative', marginTop: '12px', boxShadow: plan.pop ? '4px 6px 20px rgba(0,0,0,0.12), inset 0 0 0 2px rgba(59,130,246,0.4)' : '3px 4px 14px rgba(0,0,0,0.08), 0 1px 3px rgba(0,0,0,0.05)', gridColumn: plan.studentOnly ? '2' : 'auto' }}>
                    ...
                    <p style={{ fontSize: '12px', color: '#374151', lineHeight: 1.6, marginBottom: '18px', fontFamily: "'Patrick Hand', sans-serif", fontSize: '14px' }}>{plan.tagline}</p>
