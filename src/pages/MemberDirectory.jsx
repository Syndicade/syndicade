        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4" role="dialog" aria-modal="true" aria-labelledby="manual-pay-title">
          ...
          <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-sm p-6">
            ...
            <button
              ...
              className="w-full px-4 py-2.5 bg-blue-500 text-white text-sm font-semibold rounded-lg hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1 transition-colors"
            >
              Close
            </button>
          </div>
