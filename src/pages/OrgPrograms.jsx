...
function OrgPrograms() {
  ...
  if (loading) {
    return (
      <div style={{ minHeight: '100vh', background: pageBg, padding: '32px 24px', fontFamily: "'Inter','Segoe UI',system-ui,sans-serif" }}>
  ...
  return (
    <>
      <div style={{ minHeight: '100vh', background: pageBg, fontFamily: "'Inter','Segoe UI',system-ui,sans-serif", padding: '32px 24px' }}>
        ...
        <div style={{ display: 'flex', alignItems: 'flex-start', justifyContent: 'space-between', flexWrap: 'wrap', gap: '16px', marginBottom: '28px' }}>
          <div>
            ...
            {organization && (
              <p style={{ fontSize: '13px', color: textMuted, margin: '4px 0 0' }}>{organization.name}</p>
            )}
          </div>
