    ...
    <div style={{ textAlign: 'center', padding: '48px 24px 32px' }}>
      ...
      <div style={{ textAlign: 'left', maxWidth: '640px', margin: '0 auto' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(280px, 1fr))', gap: '10px' }}>
          {PLATFORM_TEMPLATES.opportunity.slice(0, 4).map(function(tmpl) {
            return (
      ...
      {isVerified && (
        <>
          ...
          {!loading && items.length === 0 && (
            <div style={{ background: cardBg, border: '1px solid ' + borderColor, borderRadius: '12px', padding: '24px' }}>
              <EmptyState onAdd={function() { setEditing(null); setTemplateBanner(null); setShowModal(true); }} onBrowseTemplates={function(tmpl) { if (tmpl && tmpl._id) { handleTemplateSelect(tmpl, tmpl.title); } else { setShowTemplatePicker(true); } }} isVerified={true} />
            </div>
          )}
